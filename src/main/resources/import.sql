insert into users (user_id, user_fname, user_lname, user_email, user_pass, user_mobile)
insert into users (user_id,user_fname,user_lname,user_email,user_pass,user_mobile) values (1,'Aadeesh','Jain','aadeeshjain.91a@yahoo.com','abcd@234','9876543212');
